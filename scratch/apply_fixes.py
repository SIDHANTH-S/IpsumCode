...
# We will apply the color replacement dictionary to the Widget and Block files
replacements = {
    # Surfaces
...
# Apply hex token replacements to Widget and Block files
for root, _, files in os.walk('src'):
    for file in files:
        if file.endswith(('.tsx', '.ts')) and ('Widget' in file or 'Block' in file):
